<aside class="schedule">
	...
	<section class="panel panel-default">
		...
		<div id="monday" class="panel-body collapse">
	...
	<section class="panel panel-default">
		...
		<div id="tuesday" class="panel-body collapse">
			<section class="accordion-inner">
	...
	<section class="panel panel-default">
		...
		<div id="wednesday" class="panel-body collapse">
			<section class="accordion-inner">
	...
	<section class="panel panel-default">
		...
		<div id="friday" class="panel-body collapse">
			<section class="accordion-inner">
